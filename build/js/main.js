...
var _MenuIcon = require("./modules/menu-icon");

var _MenuIcon2 = _interopRequireWildcard(_MenuIcon);

(function () {
	"use strict";
	document.addEventListener("DOMContentLoaded", function (_) {
		new _MenuIcon2["default"]();
	});
})();
...
var _Snap = require('snapsvg');

var _Snap2 = _interopRequireWildcard(_Snap);
...
var MenuIcon = (function () {
	...
	_createClass(MenuIcon, [{
		key: 'CrossMorph',
		value: function CrossMorph(e) {
			var rec = _Snap2['default']('#Rectangle-1');
			var rec2 = _Snap2['default']('#Rectangle-2');
			var rec3 = _Snap2['default']('#Rectangle-3');
			if (this.toggle) {
				e.preventDefault();
		...
		key: 'elasticMorph',
		value: function elasticMorph() {}
	}, {
		key: 'toggleCss',
		value: function toggleCss() {
...
},{"snapsvg":3}],3:[function(require,module,exports){
// Snap.svg 0.4.0
// 
